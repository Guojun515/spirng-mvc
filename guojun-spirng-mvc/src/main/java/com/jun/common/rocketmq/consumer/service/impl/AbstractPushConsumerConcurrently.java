package com.jun.common.rocketmq.consumer.service.impl;
...
/**
 * 
 * @Description consumer实现的基类（实时消费）
 * @author Guojun
 * @Date 2018年5月13日 下午9:01:42
 *
 */
public abstract class AbstractPushConsumerConcurrently implements IPushConsumer {
	
	private static final Logger LOGGER = LoggerFactory.getLogger(AbstractPushConsumerConcurrently.class); 
	...
	public void startConsumption() {
		...
		try {
			...
			LOGGER.error("startConsumption:", e);
		}
